...
export default function TvShows() {
  ...
  let getTvShowsTrending =  async() => {
    let {data} = await axios.get('https://api.themoviedb.org/3/trending/person/day?api_key=e89e2122754e6a1f2189e7163707309d')
    ...
    <div>
           <div className="row gy-5 pt-5">
            ...
            <div className="col-md-2 " key={index}>
              <img className='w-100 mb-3'  src={imgSrc + item.profile_path} alt="" />
